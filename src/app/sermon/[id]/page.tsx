...
export default function SermonDetail() {
  ...
  // Type assertion to Sermon type
  const sermon = sermons.find(sermon => sermon.id === id) as Sermon | undefined;
          ...
          <div className="lg:w-1/3">
            ...
            <div className="bg-white rounded-xl shadow-md p-6 mb-8">
              ...
              <button className="w-full py-2 bg-gray-100 hover:bg-gray-200 rounded-lg text-sm font-medium">
                View All Sermons by {sermon.preacher.name?.split(' ')[0] || 'this preacher'}
              </button>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="space-y-4">
                {sermons.slice(0, 3).map((recentSermon: Sermon) => (
                  <Link 
                    key={recentSermon.id} 
